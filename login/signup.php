...
<p><a href="http://'.$site_url.'/confirmation.php?passkey='.$confirm_code.'" class="btn btn-success">Verify Account</a> </p>

  <p>If you did not sign up on <strong><a href="http://'.$site_url.'"> ChoiceWorker</a></strong>, please ignore this email. We will remove your details from our server but we think you should atleast have a look at what we do.</p>
